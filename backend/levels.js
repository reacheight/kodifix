export const levels = {
  [0]: {
    ...
    width: 12,
    grid: [
      ["lawn","lawn","lawn","lawn","lawn","sand","sand","lawn","lawn","tree","lawn","lawn",],
      ["lawn","lawn","tree","sand","sand","sand","sand","sand","lawn","lawn","grass","lawn",],
      ["lawn","lawn","lawn","sand","lawn","lawn","lawn","sand","lawn","lawn","lawn","lawn",],
      ["lawn","grass","lawn","sand","sand","rock","water","water","water","lawn","lawn","lawn",],
      ["lawn","lawn","lawn","lawn","lawn","sand","water","water","water","lawn","lawn","lawn",],
      ["lawn","rock","sand","sand","sand","sand","sand","sand","sand","rock","tree","lawn",],
      ...
      ["lawn","tree","lawn","lawn","grass","sand","sand","lawn","lawn","lawn","lawn","lawn",],
      ["tree","lawn","lawn","lawn","lawn","sand","sand","lawn","lawn","lawn","lawn","lawn",],
      ["lawn","tree","lawn","lawn","sand","rock","sand","sand","lawn","tree","lawn","lawn",],
    ],
    hero: { x: 11, y: 6 },
    finish: { x: 0, y: 6 },
    gems: [
  ...
  [3]: {
    ...
    width: 7,
    grid: [
      ["tree","lawn","sand","lawn","grass","lawn","lawn",],
  ...
  [5]: {
    ...
    width: 9,
    grid: [
      ["tree","lawn","tree","water","water","water","lawn","tree","lawn",],
      ["sand","sand","grass","water","water","water","lawn","sand","tree",],
      ["lawn","sand","sand","water","water","water","sand","sand","sand",],
      ["lawn","grass","lawn","water","water","water","lawn","sand","lawn",],
    ],
    hero: { x: 2, y: 0 },
    finish: { x: 2, y: 8 },
    gems: [
  ...
  [6]: {
    ...
    width: 9,
    grid: [
      ["lawn","lawn","grass","water","water","water","tree","sand","tree",],
      ["sand","sand","sand","water","water","water","sand","sand","lawn",],
      ["lawn","sand","lawn","water","water","water","grass","lawn","lawn",],
  ...
  [10]: {
    ...
    grid: [
      ...
      ["water","water","water","water","water","rock","sand","rock",],
  ...
  [11]: {
    ...
    width: 15,
    grid: [
      ["lawn","lawn","lawn","water","water","water","lawn","lawn", "lawn","water","water","water","water","water", "water"],
      ...
      ["water","water","water","water","water","water","water","water", "water","water","water","water","water","water", "water"],
      ["water","water","water","water","water","water","water","water", "water","water","water","water","water","water", "water"],
      ["water","water","water","water","water","water","lawn","sand", "lawn","water","water","water","lawn","lawn", "lawn"],
      ["water","water","water","water","water","water","sand","sand", "grass","water","water","water","lawn","lawn", "lawn"],
      ["water","water","water","water","water","water","lawn","lawn", "lawn","water","water","water","lawn","lawn", "lawn"],
    ],
    hero: { x: 1, y: 7 },
    finish: { x: 7, y: 14 },
    gems: [
  ...
  [12]: {
    ...
    width: 8,
    grid: [
      ["tree","sand","sand","water","water","sand","lawn","grass"],
      ...
      ["lawn","grass","sand","water","water","sand","sand","sand"],
      ["lawn","sand","water","water","sand","sand","water","water"],
      ["sand","water","water","sand","grass","lawn","water","sand"],
    ],
    hero: { x: 3, y: 0 },
    finish: { x: 6, y: 5 },
    gems: [
