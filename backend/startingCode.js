...
`,
    ...
    [18]: `# исправь код внутри цикла, чтобы добраться
...
while True:
    ...
    hero.move_right()
    `,
    [19]: `# исправь код внутри цикла, чтобы добраться
# до финиша и собрать все алмазы
...
`,
    [21]: `# не на каждом шаге цикла будет враг
...
while True:
    ...
    [22]: `while True:
    # напиши код
    # для каждого шага цикла самостоятельно
    `,
    [23]: `# дойди до берега
hero.move_right()
...
# дойди до финиша
`,
    [24]: `# напиши весь кода сам!`,

    [25]: `# дойди до случайного врага
hero.move_down()
hero.move_right(2)
hero.move_down(3)
...
`,
    ...
    [26]: `# используй конструкцию if,
# чтобы проверять, закрыт ли мост,
# и есть ли рядом враг

`,

    [27]: `# дойди до конца левого моста
hero.move_left(4)
# если рядом есть враг, то
