...
`,
    ...
    [11]: `# чтобы пройти этот уровень,\n# тебе надо использовать все методы\n\n`,
    [12]: `# не дай огромному рыцарю
...
# дойди до финиша
`,
    [16]: `# напиши весь кода сам!`,

    [17]: `# дойди до верхнего моста
hero.move_down()
hero.move_right(2)
...
# дойди до финиша
`,
    [18]: `# дойди до конца левого моста
hero.move_left(4)
