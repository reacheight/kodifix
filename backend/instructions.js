...
hero.move_down(2)             # всегда пройди вниз`,
    ...
    [19]: {
      instructions: 'Так держать! Давай закрепим знания. Помни, что мосты на этом уровне тоже случайные — они могут быть открыты или закрыты.\n\n'
      + 'Используй конструкцию `if` и метод `is_disabled` для проверки каждого моста.\n\n'
